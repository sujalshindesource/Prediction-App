...
// Add useMemo to your import at the top of the file:
  ...
  return (
    <div style={styles.stepContainer}>
      ...
      <div style={styles.attribution}>
        Devloped by nano , pranv , Siddhesh 
      </div>
    </div>
  );
}
...
function PredictionTypeScreen({ formData, setFormData, onNext }) {
  ...
  return (
    <div style={styles.stepContainer}>
      ...
      {/* Footer Attribution */}
      <div style={styles.attribution}>
        © 2024 FUTURE INSIGHT  . ALL DIMENSIONS SECURED.
      </div>
    </div>
  );
}
...
function ResultsScreen({ formData, savedResults, onSaveResults, onRestart }) {
  ...
  // AFTER:
const results = useMemo(() => savedResults || {
